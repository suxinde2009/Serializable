...
extension Date: StringInitializable {
    static private let internalDateFormatter = DateFormatter()
...
let validHexRegex = try! RegularExpression(pattern: "[0-9A-F]{6}", options: RegularExpression.Options(rawValue: 0))
